# Awesome Federated Computing with stars
...
* [OpenFL: An open-source framework for Federated Learning](https://arxiv.org/abs/2105.06413), preprint. \[[code](https://github.com/intel/openfl) ⭐ 843 | 🐛 83 | 🌐 Python | 📅 2026-08-25] ![alt text](https://github.com/tushar-semwal/awesome-federated-computing/blob/master/imgs/github-logo-16px.png)
* [FedBN: Federated Learning on Non-IID Features via Local Batch Normalization](https://arxiv.org/abs/2102.07623), ICLR 2021 \[[code](https://github.com/med-air/FedBN) ⭐ 272 | 🐛 7 | 🌐 Python | 📅 2025-11-13] ![alt text](https://github.com/tushar-semwal/awesome-federated-computing/blob/master/imgs/github-logo-16px.png)
...
* [Federated Visual Classification with Real-World Data Distribution](https://arxiv.org/abs/2003.08082), ECCV 2020 \[[code](https://github.com/google-research/google-research/tree/master/federated_vision_datasets) ⭐ 38,781 | 🐛 1,994 | 🌐 Jupyter Notebook | 📅 2026-09-16] ![alt text](https://github.com/tushar-semwal/awesome-federated-computing/blob/master/imgs/github-logo-16px.png)
* [FedML: A Research Library and Benchmark for Federated Machine Learning](https://arxiv.org/abs/2007.13518), preprint \[[code](https://github.com/FedML-AI/FedML) ⭐ 4,065 | 🐛 147 | 🌐 Python | 📅 2025-10-28] ![alt text](https://github.com/tushar-semwal/awesome-federated-computing/blob/master/imgs/github-logo-16px.png)
...
* [Clustered Federated Learning: Model-Agnostic Distributed Multi-Task Optimization under Privacy Constraints](https://arxiv.org/abs/1910.01991), IEEE Transaction on Neural Nets, \[[Code](https://github.com/felisat/clustered-federated-learning) ⭐ 189 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2021-03-16] ![alt text](https://github.com/tushar-semwal/awesome-federated-computing/blob/master/imgs/github-logo-16px.png)
...
* [PySyft - Github](https://github.com/OpenMined/PySyft) ⭐ 10,031 | 🐛 15 | 🌐 Python | 📅 2026-09-17 - The PyTorch based library.
* [Industrial Federated Learning Framework](https://github.com/WeBankFinTech/FATE) ⭐ 6,096 | 🐛 18 | 🌐 Python | 📅 2024-11-19, Federated AI Technology Enabler, WeBank AI
* [PyTorch Federated Learning - Github](https://github.com/shaoxiongji/federated-learning) ⭐ 1,517 | 🐛 16 | 🌐 Python | 📅 2024-07-25
...
* [PySyft](https://github.com/OpenMined/PySyft/tree/dev/examples/tutorials) ⭐ 10,031 | 🐛 15 | 🌐 Python | 📅 2026-09-17
...
* [Federated iNaturalist/Landmarks](https://github.com/google-research/google-research/tree/master/federated_vision_datasets) ⭐ 38,781 | 🐛 1,994 | 🌐 Jupyter Notebook | 📅 2026-09-16
...
* Ownership Protocol by [Qibing Lee](https://github.com/ownership-labs)
  ...
  * [Compute-to-Data](https://github.com/ownership-labs/Compute-to-Data) ⚠️ Archived
